...
ASUN_FIELDS(FullUser, (id,"id","int"),(name,"name","str"),(age,"age","int"),(active,"active","bool"),(score,"score","float"))

struct MiniUser { int64_t id=0; std::string name; };
ASUN_FIELDS(MiniUser, (id,"id","int"),(name,"name","str"))

// Dim 2
struct RichProfile { int64_t id=0; std::string name; std::vector<std::string> tags; std::vector<int64_t> scores; };
ASUN_FIELDS(RichProfile, (id,"id","int"),(name,"name","str"),(tags,"tags","@[str]"),(scores,"scores","@[int]"))

struct ThinProfile { int64_t id=0; std::string name; };
ASUN_FIELDS(ThinProfile, (id,"id","int"),(name,"name","str"))

// Dim 3: nested
struct InnerFull { int64_t x=0; int64_t y=0; double z=0; bool w=false; };
ASUN_FIELDS(InnerFull, (x,"x","int"),(y,"y","int"),(z,"z","float"),(w,"w","bool"))

struct OuterFull { std::string name; InnerFull inner; bool flag=false; };
ASUN_FIELDS(OuterFull, (name,"name","str"),(inner,"inner","@{x@int,y@int,z@float,w@bool}"),(flag,"flag","bool"))

struct InnerThin { int64_t x=0; int64_t y=0; };
ASUN_FIELDS(InnerThin, (x,"x","int"),(y,"y","int"))

struct OuterThin { std::string name; InnerThin inner; };
ASUN_FIELDS(OuterThin, (name,"name","str"),(inner,"inner","@{x@int,y@int}"))

// Dim 4: vec of nested
struct TaskFull { std::string title; bool done=false; int64_t priority=0; double weight=0; };
ASUN_FIELDS(TaskFull, (title,"title","str"),(done,"done","bool"),(priority,"priority","int"),(weight,"weight","float"))

struct ProjectFull { std::string name; std::vector<TaskFull> tasks; };
ASUN_FIELDS(ProjectFull, (name,"name","str"),(tasks,"tasks","@[{title@str,done@bool,priority@int,weight@float}]"))

struct TaskThin { std::string title; bool done=false; };
ASUN_FIELDS(TaskThin, (title,"title","str"),(done,"done","bool"))

struct ProjectThin { std::string name; std::vector<TaskThin> tasks; };
ASUN_FIELDS(ProjectThin, (name,"name","str"),(tasks,"tasks","@[{title@str,done@bool}]"))

// Dim 5: deep 3-level
struct L3Full { int64_t a=0; std::string b; bool c=false; };
ASUN_FIELDS(L3Full, (a,"a","int"),(b,"b","str"),(c,"c","bool"))

struct L2Full { std::string name; L3Full sub; int64_t code=0; std::vector<std::string> tags; };
ASUN_FIELDS(L2Full, (name,"name","str"),(sub,"sub","@{a@int,b@str,c@bool}"),(code,"code","int"),(tags,"tags","@[str]"))

struct L1Full { int64_t id=0; L2Full child; std::string extra; };
ASUN_FIELDS(L1Full, (id,"id","int"),(child,"child","@{name@str,sub@{a@int,b@str,c@bool},code@int,tags@[str]}"),(extra,"extra","str"))

struct L3Thin { int64_t a=0; };
ASUN_FIELDS(L3Thin, (a,"a","int"))

struct L2Thin { std::string name; L3Thin sub; };
ASUN_FIELDS(L2Thin, (name,"name","str"),(sub,"sub","@{a@int}"))

struct L1Thin { int64_t id=0; L2Thin child; };
ASUN_FIELDS(L1Thin, (id,"id","int"),(child,"child","@{name@str,sub@{a@int}}"))

// Dim 6: field reorder
struct OrderABC { int64_t a=0; std::string b; bool c=false; };
ASUN_FIELDS(OrderABC, (a,"a","int"),(b,"b","str"),(c,"c","bool"))

struct OrderCAB { bool c=false; int64_t a=0; std::string b; };
ASUN_FIELDS(OrderCAB, (c,"c","bool"),(a,"a","int"),(b,"b","str"))

// Dim 7: reorder + drop
struct BigRecord { int64_t id=0; std::string name; double score=0; bool active=false; int64_t level=0; };
ASUN_FIELDS(BigRecord, (id,"id","int"),(name,"name","str"),(score,"score","float"),(active,"active","bool"),(level,"level","int"))

struct SmallReordered { double score=0; int64_t id=0; };
ASUN_FIELDS(SmallReordered, (score,"score","float"),(id,"id","int"))

// Dim 8: target extra fields
struct SrcSmall { int64_t id=0; std::string name; };
ASUN_FIELDS(SrcSmall, (id,"id","int"),(name,"name","str"))

struct DstBig { int64_t id=0; std::string name; bool missing=false; double extra=0; };
ASUN_FIELDS(DstBig, (id,"id","int"),(name,"name","str"),(missing,"missing","bool"),(extra,"extra","float"))

// Dim 9: optional
struct SrcWithOpt { int64_t id=0; std::optional<std::string> label; std::optional<double> score_opt; bool flag=false; };
ASUN_FIELDS(SrcWithOpt, (id,"id","int"),(label,"label","str"),(score_opt,"score","float"),(flag,"flag","bool"))

struct DstFewerOpt { int64_t id=0; std::optional<std::string> label; };
ASUN_FIELDS(DstFewerOpt, (id,"id","int"),(label,"label","str"))

// Matrix P1/P2/N4
struct MatrixPart { int64_t id=0; double score=0; };
ASUN_FIELDS(MatrixPart, (id,"id","int"),(score,"score","float"))

struct MatrixNoOverlap { int64_t foo=0; std::string bar; };
ASUN_FIELDS(MatrixNoOverlap, (foo,"foo","int"),(bar,"bar","str"))

struct MatrixNestedOpt { std::string name; std::optional<std::string> nick; };
ASUN_FIELDS(MatrixNestedOpt, (name,"name","str"),(nick,"nick","str"))

struct MatrixUserNestedOpt { int64_t id=0; MatrixNestedOpt profile; };
ASUN_FIELDS(MatrixUserNestedOpt, (id,"id","int"),(profile,"profile","@{name@str,nick@str}"))

// Dim 10: special string
struct SrcSpecialStr { int64_t id=0; std::string name; std::string bio; };
ASUN_FIELDS(SrcSpecialStr, (id,"id","int"),(name,"name","str"),(bio,"bio","str"))

struct DstNoStr { int64_t id=0; };
ASUN_FIELDS(DstNoStr, (id,"id","int"))

// Dim 11: trailing arrays
struct SrcNestedArr { int64_t id=0; std::vector<int64_t> matrix; std::vector<std::string> tags; };
ASUN_FIELDS(SrcNestedArr, (id,"id","int"),(matrix,"matrix","@[int]"),(tags,"tags","@[str]"))

// Dim 14: negative
struct SrcNegative { int64_t a=0; int64_t b=0; double c=0; std::string d; };
ASUN_FIELDS(SrcNegative, (a,"a","int"),(b,"b","int"),(c,"c","float"),(d,"d","str"))

struct DstNegThin { int64_t a=0; int64_t b=0; };
ASUN_FIELDS(DstNegThin, (a,"a","int"),(b,"b","int"))

// Dim 15: empty string
struct SrcEmpty { int64_t id=0; std::string name; std::string bio; };
ASUN_FIELDS(SrcEmpty, (id,"id","int"),(name,"name","str"),(bio,"bio","str"))

struct DstEmptyThin { int64_t id=0; };
ASUN_FIELDS(DstEmptyThin, (id,"id","int"))

// Dim 16: entry list
struct MetaEntry { std::string key; int64_t value=0; };
ASUN_FIELDS(MetaEntry, (key,"key","str"),(value,"value","int"))

struct SrcWithEntries { int64_t id=0; std::string name; std::vector<MetaEntry> meta; };
ASUN_FIELDS(SrcWithEntries, (id,"id","int"),(name,"name","str"),(meta,"meta","@[{key@str,value@int}]"))

struct DstMetaThin { int64_t id=0; std::string name; };
ASUN_FIELDS(DstMetaThin, (id,"id","int"),(name,"name","str"))

// Dim 20: bools
struct SrcBools { int64_t id=0; bool a=false; bool b=false; bool c=false; };
ASUN_FIELDS(SrcBools, (id,"id","int"),(a,"a","bool"),(b,"b","bool"),(c,"c","bool"))

struct DstBoolsThin { int64_t id=0; };
ASUN_FIELDS(DstBoolsThin, (id,"id","int"))

// Dim 21: five fields
struct SrcFive { int64_t a=0; std::string b; double c=0; bool d=false; int64_t e=0; };
ASUN_FIELDS(SrcFive, (a,"a","int"),(b,"b","str"),(c,"c","float"),(d,"d","bool"),(e,"e","int"))

struct DstMiddleOnly { double c=0; };
ASUN_FIELDS(DstMiddleOnly, (c,"c","float"))

struct DstLastOnly { int64_t e=0; };
ASUN_FIELDS(DstLastOnly, (e,"e","int"))

// Dim 23: no overlap
struct SrcAlpha { int64_t x=0; std::string y; };
ASUN_FIELDS(SrcAlpha, (x,"x","int"),(y,"y","str"))

struct DstBeta { int64_t p=0; std::string q; };
ASUN_FIELDS(DstBeta, (p,"p","int"),(q,"q","str"))
...
ASUN_FIELDS(WorkerFull, (name,"name","str"),(skills,"skills","@[str]"),(years_xp,"years_xp","int"),(rating,"rating","float"))

struct TeamFull { std::string lead; std::vector<WorkerFull> workers; double budget=0; };
ASUN_FIELDS(TeamFull, (lead,"lead","str"),(workers,"workers","@[{name@str,skills@[str],years_xp@int,rating@float}]"),(budget,"budget","float"))

struct WorkerThin { std::string name; std::vector<std::string> skills; };
ASUN_FIELDS(WorkerThin, (name,"name","str"),(skills,"skills","@[str]"))

struct TeamThin { std::string lead; std::vector<WorkerThin> workers; };
ASUN_FIELDS(TeamThin, (lead,"lead","str"),(workers,"workers","@[{name@str,skills@[str]}]"))
...
ASUN_FIELDS(SrcWide, (f1,"f1","int"),(f2,"f2","str"),(f3,"f3","bool"),(f4,"f4","int"),(f5,"f5","str"),(f6,"f6","bool"),(f7,"f7","int"),(f8,"f8","str"),(f9,"f9","bool"),(f10,"f10","int"))

struct DstNarrow { int64_t f1=0; };
ASUN_FIELDS(DstNarrow, (f1,"f1","int"))

// Dim 28: asun-like string
struct SrcAsunLike { int64_t id=0; std::string data; std::string code; };
ASUN_FIELDS(SrcAsunLike, (id,"id","int"),(data,"data","str"),(code,"code","str"))

// Dim 29: unicode
struct SrcUnicode { int64_t id=0; std::string name; std::string bio; };
ASUN_FIELDS(SrcUnicode, (id,"id","int"),(name,"name","str"),(bio,"bio","str"))

// Dim 30: roundtrip
struct VersionA { int64_t id=0; std::string name; bool active=false; };
ASUN_FIELDS(VersionA, (id,"id","int"),(name,"name","str"),(active,"active","bool"))

struct VersionB { int64_t id=0; std::string name; };
ASUN_FIELDS(VersionB, (id,"id","int"),(name,"name","str"))

// Dim 31: arr in middle
struct SrcWithArr { int64_t id=0; std::vector<std::string> items; int64_t score=0; };
ASUN_FIELDS(SrcWithArr, (id,"id","int"),(items,"items","@[str]"),(score,"score","int"))

struct DstWithArrThin { int64_t id=0; std::vector<std::string> items; };
ASUN_FIELDS(DstWithArrThin, (id,"id","int"),(items,"items","@[str]"))

// Dim 32: nested struct skip
struct InnerSkip { int64_t a=0; std::string b; };
ASUN_FIELDS(InnerSkip, (a,"a","int"),(b,"b","str"))

struct SrcWithNested { int64_t id=0; InnerSkip inner; std::string tail; };
ASUN_FIELDS(SrcWithNested, (id,"id","int"),(inner,"inner","@{a@int,b@str}"),(tail,"tail","str"))

struct DstFlat { int64_t id=0; };
ASUN_FIELDS(DstFlat, (id,"id","int"))

// Dim 13: float roundtrip
struct SrcFloat { int64_t id=0; double value=0; };
ASUN_FIELDS(SrcFloat, (id,"id","int"),(value,"value","float"))

// Dim 25: typed mixed
struct SrcTyped { int64_t a=0; std::string b; double c=0; bool d=false; };
ASUN_FIELDS(SrcTyped, (a,"a","int"),(b,"b","str"),(c,"c","float"),(d,"d","bool"))

struct DstMixed { std::string b; bool d=false; int64_t extra=0; double more=0; };
ASUN_FIELDS(DstMixed, (b,"b","str"),(d,"d","bool"),(extra,"extra","int"),(more,"more","float"))

// Dim 19: nested vec + trailing
struct DetailFull { int64_t id=0; std::string name; int32_t age=0; bool gender=false; };
ASUN_FIELDS(DetailFull, (id,"ID","int"),(name,"Name","str"),(age,"Age","int"),(gender,"Gender","bool"))

struct UserFull2 { std::vector<DetailFull> details; int64_t code=0; std::string label; };
ASUN_FIELDS(UserFull2, (details,"details","@[{ID@int,Name@str,Age@int,Gender@bool}]"),(code,"code","int"),(label,"label","str"))

struct PersonThin { int64_t id=0; std::string name; };
ASUN_FIELDS(PersonThin, (id,"ID","int"),(name,"Name","str"))

struct HumanThin { std::vector<PersonThin> details; };
ASUN_FIELDS(HumanThin, (details,"details","@[{ID@int,Name@str}]"))
...
void test_cross_trailing_fields_vec() {
    ...
    auto data = asun::encode(src);
    auto dst = asun::decode<std::vector<MiniUser>>(data);
...
void test_cross_trailing_fields_single() {
    ...
    auto data = asun::encode(src);
    auto dst = asun::decode<MiniUser>(data);
...
void test_cross_skip_trailing_collections() {
    ...
    auto data = asun::encode(src);
    auto dst = asun::decode<ThinProfile>(data);
...
void test_cross_nested_fewer_fields() {
    ...
    auto data = asun::encode(src);
    auto dst = asun::decode<OuterThin>(data);
...
void test_cross_vec_nested_skip() {
    ...
    auto data = asun::encode(src);
    auto dst = asun::decode<std::vector<ProjectThin>>(data);
    ASSERT_EQ(dst.size(), 2u);
...
void test_cross_deep_3_levels() {
    ...
    auto data = asun::encode(src);
    auto dst = asun::decode<L1Thin>(data);
    ASSERT_EQ(dst.id, 1);
...
void test_cross_field_reorder() {
    ...
    auto data = asun::encode(src);
    auto dst = asun::decode<OrderCAB>(data);
...
void test_cross_reorder_drop() {
    ...
    auto data = asun::encode(src);
    auto dst = asun::decode<std::vector<SmallReordered>>(data);
    ASSERT_EQ(dst.size(), 2u);
...
void test_cross_target_extra_fields() {
    ...
    auto data = asun::encode(src);
    auto dst = asun::decode<DstBig>(data);
...
void test_cross_optional_skip() {
    ...
    auto data = asun::encode(src);
    auto dst = asun::decode<DstFewerOpt>(data);
    ASSERT_EQ(dst.id, 1);
...
void test_cross_skip_special_string() {
    ...
    auto data = asun::encode(src);
    auto dst = asun::decode<DstNoStr>(data);
    ASSERT_EQ(dst.id, 1);
    PASS();
}
...
void test_cross_skip_trailing_arrays() {
    ...
    auto data = asun::encode(src);
    auto dst = asun::decode<std::vector<DstNoStr>>(data);
    ASSERT_EQ(dst.size(), 2u);
...
void test_cross_float_roundtrip() {
    ...
    auto data = asun::encode(src);
    auto dst = asun::decode<SrcFloat>(data);
...
void test_cross_negative_skip() {
    ...
    auto data = asun::encode(src);
    auto dst = asun::decode<DstNegThin>(data);
...
void test_cross_empty_string() {
    ...
    SrcEmpty src{1,"",""};
    auto data = asun::encode(src);
    auto dst = asun::decode<DstEmptyThin>(data);
    ASSERT_EQ(dst.id, 1);
    PASS();
}
...
void test_cross_skip_entry_list() {
    ...
    auto data = asun::encode(src);
    auto dst = asun::decode<DstMetaThin>(data);
    ASSERT_EQ(dst.id, 1); ASSERT_EQ(dst.name, "Alice");
    PASS();
}
...
void test_cross_typed_vec() {
    ...
    auto data = asun::encode_typed(src);
    auto dst = asun::decode<std::vector<MiniUser>>(data);
...
void test_cross_nested_vec_trailing_outer() {
    ...
    auto data = asun::encode(src);
    auto dst = asun::decode<std::vector<HumanThin>>(data);
    ASSERT_EQ(dst.size(), 1u);
...
void test_cross_skip_bools() {
    ...
    auto data = asun::encode(src);
    auto dst = asun::decode<std::vector<DstBoolsThin>>(data);
    ASSERT_EQ(dst.size(), 2u);
    ASSERT_EQ(dst[0].id, 1); ASSERT_EQ(dst[1].id, 2);
    PASS();
}
...
void test_cross_pick_middle() {
    ...
    auto data = asun::encode(src);
    auto dst = asun::decode<DstMiddleOnly>(data);
...
void test_cross_pick_last() {
    ...
    auto data = asun::encode(src);
    auto dst = asun::decode<DstLastOnly>(data);
    ASSERT_EQ(dst.e, 42);
    PASS();
}
...
void test_cross_no_overlap() {
    ...
    auto data = asun::encode(src);
    auto dst = asun::decode<DstBeta>(data);
...
void test_cross_nested_array_structs() {
    ...
    auto data = asun::encode(src);
    auto dst = asun::decode<TeamThin>(data);
...
void test_cross_typed_mixed() {
    ...
    auto data = asun::encode_typed(src);
    auto dst = asun::decode<DstMixed>(data);
...
void test_cross_many_trailing() {
    ...
    auto data = asun::encode(src);
    auto dst = asun::decode<DstNarrow>(data);
    ASSERT_EQ(dst.f1, 42);
    PASS();
}
...
void test_cross_asun_syntax_string() {
    TEST(asun_syntax_string);
    SrcAsunLike src{1, "{a,b}:(1,2)", "<x:y,z:w>"};
    auto data = asun::encode(src);
    auto dst = asun::decode<DstNoStr>(data);
    ASSERT_EQ(dst.id, 1);
    PASS();
...
void test_cross_roundtrip_abba() {
    ...
    auto da = asun::encode(a);
    auto b = asun::decode<VersionB>(da);
    ASSERT_EQ(b.id, 1); ASSERT_EQ(b.name, "test");
    auto db = asun::encode(b);
    auto a2 = asun::decode<VersionA>(db);
...
void test_cross_empty_array_middle() {
    ...
    auto data = asun::encode(src);
    auto dst = asun::decode<std::vector<DstWithArrThin>>(data);
    ASSERT_EQ(dst.size(), 2u);
...
void test_cross_skip_nested_tuple() {
    ...
    auto data = asun::encode(src);
    auto dst = asun::decode<DstFlat>(data);
    ASSERT_EQ(dst.id, 1);
    PASS();
}
...
void test_matrix_partial_overlap_typed() {
    ...
    auto dst = asun::decode<MatrixPart>("{id@int,name@str,score@float,active@bool}:(42,Alice,9.5,true)");
    ASSERT_EQ(dst.id, 42);
...
void test_matrix_partial_overlap_untyped() {
    ...
    auto dst = asun::decode<MatrixPart>("{id,name,score,active}:(42,Alice,9.5,true)");
    ASSERT_EQ(dst.id, 42);
    ASSERT_NEAR(dst.score, 9.5, 1e-10);
    PASS();
}
...
void test_matrix_no_overlap_typed() {
    ...
    auto dst = asun::decode<MatrixNoOverlap>("{id@int,name@str}:(42,Alice)");
    ASSERT_EQ(dst.foo, 0);
    ASSERT_EQ(dst.bar, "");
    PASS();
}
...
void test_matrix_no_overlap_untyped() {
    ...
    auto dst = asun::decode<MatrixNoOverlap>("{id,name}:(42,Alice)");
    ASSERT_EQ(dst.foo, 0);
    ASSERT_EQ(dst.bar, "");
    PASS();
}
...
void test_matrix_nested_optional_typed() {
    ...
    auto dst = asun::decode<std::vector<MatrixUserNestedOpt>>(
...
int main() {
    std::cout << "=== ASUN C++ Cross-Compat Test Suite ===\n\n";
